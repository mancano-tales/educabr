...
| Discuss compatibility with [`educabR`](https://github.com/SidneyBissoli/educabR) | See [`planning/integration-educabR.md`](https://mancano-tales.github.io/planning/integration-educabR.md) and chime in via issue |
